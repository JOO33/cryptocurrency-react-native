...
export default class Line extends Component<Props, State> {
  ...
  state = {
    ...
    // animated, the graph raises from the bottom to the top of the container
    height: 0
  };
  ...
  // update the state so the component can render the graph using actual width and height
